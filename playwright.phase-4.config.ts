...
export default defineConfig({
  testDir: "./tests/e2e",
  testMatch: "phase4-lecturer.spec.ts",
  fullyParallel: false,
  workers: 1,
  use: {
    baseURL,
  ...
  projects: [
    {
      name: "phase4-lecturer-chromium",
      use: { ...devices["Desktop Chrome"] },
    },
  ],
  webServer: {
    command:
      "./node_modules/.bin/tsx scripts/phase-4/seed-lecturer-portal-e2e.ts && ./node_modules/.bin/next dev --port 3104",
